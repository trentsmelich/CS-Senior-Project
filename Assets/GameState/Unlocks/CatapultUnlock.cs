using UnityEngine;
//Author:Luis
//Description: This script manages the unlock states for the Catapult tower, including loading and saving unlock states and checking conditions for unlocking different levels.
